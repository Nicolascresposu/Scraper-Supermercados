...
urlpatterns = [
    ...
    path("api/promedios_precios/", views.precios_api, name="precios_api"),
    path("api/cantidad_productos/", views.cantidad_productos_por_supermercado, name="cantidad_productos_por_supermercado"),
    path("api/distribucion_precios/", views.distribucion_precios, name="distribucion_precios"),
