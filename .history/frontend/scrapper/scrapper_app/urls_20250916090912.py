...
urlpatterns = [
    ...
    path("api/cantidad/", views.cantidad_productos_api, name="cantidad_productos_por_supermercado"),
    path("api/distribucion/", views.distribucion_precios_api, name="distribucion_precios"),
]